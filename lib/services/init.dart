...
class Init {
  initialize() async {
    ...
    try {
      ...
      Get.lazyPut(() => RechargeRepo(apiClient: Get.find()));
      ...
      Get.lazyPut(() => RewardsController(rewardRepo: Get.find()));
      ...
      Get.lazyPut(() => RechargeController(rechargeRepo: Get.find()));
    } catch (e) {
